...
class RadioButtonRN extends React.Component {
	...
	render() {
        ...
        let { boxStyle, style, circleSize, textStyle, data, icon, activeColor, deactiveColor, boxActiveBgColor, boxDeactiveBgColor, box, textColor, testIDFunc } = this.props;
                ...
                data.map((item, index) => {
                    return (
                        <TouchableOpacity
                            ...
                            testID={testIDFunc ? testIDFunc(index) : ''}
                        >
